...
Class Ehimeprefecture_Reports_Model_Config_OutputType Extends Mage_Core_Model_Config_Data
{
    ...
    public function toOptionArray()
    {
        ...
        //return [
        //    ["title"  => $helper->__('Plain Table'),       'label' => $helper->__('Plain Table'),          'value' => self::TYPE_PLAIN_TABLE],
        //    ["title"  => $helper->__('Simple Charts'),     'label' => $helper->__('Simple Charts'),
        //     'value' => [
        //        ['value' => self::TYPE_PIE_CHART,          'title' => $helper->__('Pie Chart'),            'label' => $helper->__('Pie Chart')         ],
        //        ['value' => self::TYPE_BAR_CHART,          'title' => $helper->__('Bar Chart'),            'label' => $helper->__('Bar Chart')         ],
        //        ['value' => self::TYPE_GEO_CHART,          'title' => $helper->__('Geo Chart'),            'label' => $helper->__('Geo Chart')         ],
        //        ['value' => self::TYPE_AREA_CHART,         'title' => $helper->__('Area Chart'),           'label' => $helper->__('Area Chart')        ],
        //        ['value' => self::TYPE_LINE_CHART,         'title' => $helper->__('Line Chart'),           'label' => $helper->__('Line Chart')        ],
        //        ['value' => self::TYPE_COMBO_CHART,        'title' => $helper->__('Combo Chart'),          'label' => $helper->__('Combo Chart')       ],
        //        ['value' => self::TYPE_BUBBLE_CHART,       'title' => $helper->__('Bubble Chart'),         'label' => $helper->__('Bubble Chart')      ],
        //        ['value' => self::TYPE_COLUMN_CHART,       'title' => $helper->__('Column Chart'),         'label' => $helper->__('Column Chart')      ],
        //        ['value' => self::TYPE_TREEMAP_CHART,      'title' => $helper->__('TreeMap Chart'),        'label' => $helper->__('TreeMap Chart')     ],
        //        ['value' => self::TYPE_SCATTER_CHART,      'title' => $helper->__('Scatter Chart'),        'label' => $helper->__('Scatter Chart')     ],
        //        ['value' => self::TYPE_CANDLESTICK_CHART,  'title' => $helper->__('Candlestick Chart'),    'label' => $helper->__('Candlestick Chart') ],
        //        ['value' => self::TYPE_STEPPEDAREA_CHART,  'title' => $helper->__('SteppedArea Chart'),    'label' => $helper->__('SteppedArea Chart') ],
        //    ]],
        //
        //    ["title"  => $helper->__('Complex Charts'), 'label' => $helper->__('Complex Charts'),
        //     'value'  => [
        //        ['value' => self::TYPE_ORG_CHART,       'title' => $helper->__('Org Chart'),        'label' => $helper->__('Org Chart')         ],
        //        ['value' => self::TYPE_SANKEY_CHART,    'title' => $helper->__('Sankey Chart'),     'label' => $helper->__('Sankey Chart')      ],
        //        ['value' => self::TYPE_TIMELINE_CHART,  'title' => $helper->__('Timeline Chart'),   'label' => $helper->__('Timeline Chart')    ],
        //        ['value' => self::TYPE_HISTOGRAM_CHART, 'title' => $helper->__('Histogram Chart'),  'label' => $helper->__('Histrogram Chart')  ],
        //        ['value' => self::TYPE_CALENDAR_CHART,  'title' => $helper->__('Calendar Chart'),   'label' => $helper->__('Calendar Chart')    ],
        //    ]],
        //];

        return array(
            array("title"  => $helper->__('Plain Table'),           'label' => $helper->__('Plain Table'),          'value' => self::TYPE_PLAIN_TABLE),
            array("title"  => $helper->__('Simple Charts'),         'label' => $helper->__('Simple Charts'),
                  'value' => array(
            ...
            array("title"  => $helper->__('Complex Charts'),     'label' => $helper->__('Complex Charts'),
                  'value' => array(
